...
#    rospy.Subscriber('/flag_value', Int16, flag_node)
    ...
    writer.writerow([ "time_list", "header_seq", "time_stamp_sec", "time_stamp_nsecs", "header_frame_id", "orientation_x", "orientation_y", "orientation_z", "orientation_w","orientation_covariance", "angular_velocity_x", "angular_velocity_y", "angular_velocity_z", "angular_velocity_covariance", "linear_acceleration_x", "linear_acceleration_y", "linear_acceleration_z", "linear_acceleration_covariance"])
