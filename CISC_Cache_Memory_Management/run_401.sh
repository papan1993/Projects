...
export M5_DIR=/home/soumyadeep/Project1_SPEC-master/401.bzip2/final_project/m5out
			...
			do
				...
				do
					...
					do
						...
						$GEM5_DIR/configs/example/se.py -c $BENCHMARK -o "./data/input.program 10" -I 
						500000000 --cpu-type=$cpu --caches --l2cache --l1d_size=$i --l1i_size=$i --l2_size=$j --l1d_assoc=$m --l1i_assoc=$m 
						--l2_assoc=$n --cacheline_size=$k
					done
				done
			done
		done
