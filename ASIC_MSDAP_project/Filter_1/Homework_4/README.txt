...
code name - Homework_4, if you change, please update it in CMakeLists.txt"
...
######## STEPS TO BUILD AND RUN : Fiter.cpp #########
...
:-> "./<executable_object_name> <path_coeffiecient_file> <path_data_file> <path_output_file>"

ex 1:-> "./filter_object input_files/coeff.in input_files/data1.in output1.out"
(Note** -> Remember for example 1 : Any ouput file name can be given and the result will be in output_files)

********** OR *************

ex 2:-> "./filter_object /home/DIR_FOLDER/input_files/coeff.in /home/DIR_FOLDER/input_files/data1.in /home/DIR_FOLDER/output1.out"
